...
/**
 * @author smile
 * @ClassName RSA2Utils.java
 * @Description TODO
 * @createTime 2022年04月11日 14:47:00
 */
public class RSA2Utils {
        ...
        public static void main(String[] args) throws Exception {
            ...
            byte[] bytes = decryptByPublicKey(encryptByPublicKey, publicKey);
            System.out.println("使用私钥解密后的数据："+new String(bytes));
        }
